...
import {addCar,pickImage,uploadImage} from '../modal/firebase_functions.js';
            ...
            <TouchableOpacity style={{alignSelf:'center',width:'70%',borderRadius:20,backgroundColor:'#f2b655',marginTop:'5%',alignItems:'center'}} onPress={
              async ()=>{
                ...
                if(name!="" && company!="" && model!="" && value!="" && rate!="" && imageName!="" && imagePath!=""){
                  ...
                  await addCar(name,company,model,value,rate,url,selectedDate.getFullYear()).then(()=>{
              ...
              <Text style={{color:'white',fontSize:20,padding:'2%'}}>Add Car</Text>
            </TouchableOpacity>    
          </View>
        </View>
    );
